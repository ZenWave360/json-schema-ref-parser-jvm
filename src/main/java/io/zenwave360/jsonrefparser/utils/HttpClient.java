...
public class HttpClient {
    ...
    private static final String TRUST_ALL = String.format("%s.trustAll", RefUtils.class.getName());
    ...
    public static File downloadUrlToFile(String url, List<AuthenticationValue> auths) throws Exception {
    ...
    static String urlToString(String url, List<AuthenticationValue> auths) throws Exception {
        InputStream is = null;
